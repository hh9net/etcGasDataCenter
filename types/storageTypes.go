...
type BDdChedckyssj struct {
	...
	FNbYonghtcsc   int       `gorm:"column:F_NB_YONGHTCSC; default:'NULL'"`  //  `F_NB_YONGHTCSC` int(11) DEFAULT NULL COMMENT '用户停车时长(分)',
	...
	FNbFeil        int       `gorm:"column:F_NB_FEIL; default:'NULL'"`       //  `F_NB_FEIL` int(11) DEFAULT NULL COMMENT '费率-NEW 万分比',
	FNbShouxf      int64     `gorm:"column:F_NB_SHOUXF; default:'NULL'"`     //  `F_NB_SHOUXF` int(11) DEFAULT NULL COMMENT '手续费-NEW 单位分',
